...
"""
Created on 26/09/25
pip install pyzmq pyqtgraph pycomm3
@author: SALLEJAUNE

Serveur ZMQ REQ/REP sur port 5561.
Commandes :
...
class AlicatGui(QMainWindow):
    ...
    def __init__(self, IP='10.0.1.101', zmq_port=5561,
                 name='ROSA Gas Control', parent=None):
        super().__init__(parent)
        ...
        # --- Alicat ---
        self.alicat = AlicatController(self.IP)
        self.alicat.connect()
...
if __name__ == '__main__':
    ...
    e = AlicatGui(IP='10.0.1.101', zmq_port=5561)
